//! Go full Java-brain and synchronize various methods.
//!
...
//!
//! We also might want to limit the number of concurrent filesystem threads
//! done with [`concurrently`](super::concurrently)
...
pub fn dec(count: &AtomicU32) -> SemaphoreGuard<'_> {
    // Sanity check:
